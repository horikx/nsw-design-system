  ...
  var Navigation = /*#__PURE__*/function () {
    ...
    _createClass(Navigation, [{
        ...
        if (this.isMegaMenuElement) {
          ...
          listItems.forEach(function (item) {
            ...
            if (submenu) {
              ...
              link.removeEventListener('click', _this2.desktopButtonClickEvent, false);
              link.removeEventListener('keydown', _this2.desktopButtonKeydownEvent, false);
            }
          });
        }
      }
        ...
        if (this.isMegaMenuElement) {
          listItems.forEach(function (item) {
            ...
            if (submenu) {
              ...
              link.addEventListener('click', _this4.desktopButtonClickEvent, false);
              link.addEventListener('keydown', _this4.desktopButtonKeydownEvent, false);
              document.addEventListener('keydown', _this4.escapeCloseEvent, false);
            }
          });
        }
      }
      ...
      value: function checkIfContainsFocus() {
        ...
        var isNavLinkActive = document.activeElement.getAttribute('class').indexOf('gwic-navigation__link') > -1;
